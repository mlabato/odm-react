...
//THIS NAVBAR HAS 80 OPACITY AND ISN'T FIXED. IT'S FOR BEING USED IN OTHER PAGES THAN THE HOME PAGE.
...
const NavbarSections = () => {
  ...
  return (
    <section className=" w-full  bg-red-700 opacity-80">
      <article className=" flex flex-row justify-between w-full bg-white items-center">
      ...
      <article
        className={
          ...
          "  fixed top-15   bg-red-900  w-100 text-white space-y-5 z-20 p-2 transition-right"
        }
      >
