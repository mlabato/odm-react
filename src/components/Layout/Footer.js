...
const Footer = () => {
  return (
    <section className=" relative bg-gradient-to-r from-red-900 to-red-700 flex flex-col p-2 w-full  ">
      <a href="https://www.instagram.com/outletde_mates/" className="mx-auto">
        {" "}
        <FaInstagram className=" text-2xl sm:4xl  text-white mr-4 hover:text-gray-500 " />
      </a>
      ...
      <article className="text-white  flex flex-row mx-auto mb-2">
        <div className="p-2 ">
          ...
          <a
            href="/mates"
            className=" sm:2xl md:text-xl hover:text-gray-500 text-sm"
          >
            Mates
          </a>
        </div>
      ...
      <article className="text-white  flex flex-col mx-auto mb-2 ">
        <div className="text-xs text-center">
          © Copyright Outlet de Mates - 2022
        </div>
